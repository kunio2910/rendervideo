...
export function WhiteboardWorkspace({ onNotify }: WhiteboardWorkspaceProps) {
  ...
  const reviewAspectRatio = getAspectRatioValue(options.aspectRatio, canvas);
  const imageIsWiderThanReview = canvas.width / Math.max(1, canvas.height) >= reviewAspectRatio;
